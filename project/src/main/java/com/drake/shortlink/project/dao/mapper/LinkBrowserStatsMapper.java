package com.drake.shortlink.project.dao.mapper;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.drake.shortlink.project.dao.entity.LinkBrowserStatsDO;
...
public interface LinkBrowserStatsMapper extends BaseMapper<LinkBrowserStatsDO> {
    ...
    @Insert("INSERT INTO t_link_browser_stats (full_short_url, gid, date, cnt, browser, create_time, update_time, del_flag) " +
            ...
            "ON DUPLICATE KEY UPDATE cnt = cnt +  #{linkBrowserStats.cnt}, update_time = #{linkBrowserStats.updateTime};")
