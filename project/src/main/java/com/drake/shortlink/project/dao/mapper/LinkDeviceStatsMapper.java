...
import com.drake.shortlink.project.dao.entity.LinkDeviceStatsDO;
...
public interface LinkDeviceStatsMapper extends BaseMapper<LinkDeviceStatsDO> {
    ...
    @Insert("INSERT INTO t_link_device_stats (full_short_url, gid, date, cnt, device, create_time, update_time, del_flag) " +
            ...
            "ON DUPLICATE KEY UPDATE cnt = cnt +  #{linkDeviceStats.cnt}, update_time = #{linkDeviceStats.updateTime};")
