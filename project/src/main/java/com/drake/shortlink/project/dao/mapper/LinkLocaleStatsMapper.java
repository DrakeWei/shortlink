...
import com.drake.shortlink.project.dao.entity.LinkLocaleStatsDO;
...
public interface LinkLocaleStatsMapper extends BaseMapper<LinkLocaleStatsDO> {
    ...
    @Insert("INSERT INTO t_link_locale_stats (full_short_url, gid, date, cnt, country, province, city, adcode, create_time, update_time, del_flag) " +
            ...
            "ON DUPLICATE KEY UPDATE cnt = cnt +  #{linkLocaleStats.cnt}, update_time = #{linkLocaleStats.updateTime};")
